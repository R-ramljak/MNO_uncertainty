...
# saveRDS(area, "Data/workflow_objects/areas.rds")
```
...
First, we combine all cellplan objects into the list object `cellplans.list`, which helps with automatizing each phone-to-cell association task.
...
Then, we perform the phone-to-cell association. In the end of this notebook we save the object `gen.model.objects`, which will contain three objects for further use in the workflow:
...
# saveRDS(gen.model.objects, "workflow_objects/gen.model.objectss.rds")
